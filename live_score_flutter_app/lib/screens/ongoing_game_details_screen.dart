          ...
          builder: (context, snapshot) {
            if (snapshot.hasData && snapshot.data != null) {
              ...
              return const Center(
                child: Padding(
                  ...
                  child: Text(
                      'Game has Ended. Please look into *Previous Games Section*',textAlign: TextAlign.center,),
                ),
              );
            }
            } 
            return Container(
              ...
              child: Column(
                  ...
                  children: [
                    Text(game.gameType,style: const TextStyle(fontSize: 25,fontWeight: FontWeight.w700),),
                    const SizedBox(
                      height: 30,
                    ),
                    Row(
                              ...
                              .map((e) => Padding(
                                ...
                                child: ListTile(
                                  tileColor: Color.fromARGB(112, 157, 151, 151),
                                      title: Text(e,textAlign: TextAlign.center,style: const TextStyle(fontSize: 20),),
                                    ),
                              ))
                              .toList()),
                    )
